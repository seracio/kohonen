...
var dist = function dist(v1, v2) {
    var d = Math.sqrt(
        v1.reduce(function(seed, cur, ind) {
    ...
    (function() {
        ...
        function Kohonen(_ref) {
            var neurons = _ref.neurons,
                ...
                minLearningCoef =
                    _ref$minLearningCoef === void 0
                        ? 0.1
                        : _ref$minLearningCoef,
                _ref$maxLearningCoef = _ref.maxLearningCoef,
                maxLearningCoef =
                    _ref$maxLearningCoef === void 0
                        ? 0.4
                        : _ref$maxLearningCoef,
                _ref$minNeighborhood = _ref.minNeighborhood,
                minNeighborhood =
                    _ref$minNeighborhood === void 0
                        ? 0.3
                        : _ref$minNeighborhood,
                _ref$maxNeighborhood = _ref.maxNeighborhood,
                maxNeighborhood =
                    _ref$maxNeighborhood === void 0 ? 1 : _ref$maxNeighborhood;
            ...
            this.scaleStepLearningCoef = scaleLinear()
                .clamp(true)
                .domain([0, maxStep])
                .range([maxLearningCoef, minLearningCoef]); // decrease neighborhood with time

            this.scaleStepNeighborhood = scaleLinear()
                .clamp(true)
                .domain([0, maxStep])
                .range([maxNeighborhood, minNeighborhood]); // retrive min and max for each feature
        ...
        _createClass(Kohonen, [
            ...
            },
            {
                ...
                value: function umatrix() {
                    ...
                    return _.map(function(n) {
                        return mean(
                            findNeighors(n).map(function(nb) {
            ...
            },
            {
                ...
                value: function generateInitialVectors() {
                    ...
                    var generateRandomVecWithinEigenvectorsSpace = function generateRandomVecWithinEigenvectorsSpace() {
                        return add(
                            mult(transposedEV[0], random$1(-0.5, 0.5, true)),
                            mult(transposedEV[1], random$1(-0.5, 0.5, true))
                        );
            ...
            },
            {
                ...
                value: function learn(v) {
                    ...
                    var currentLearningCoef = this.scaleStepLearningCoef(
                        this.step
                    );
            ...
            },
            {
                ...
                value: function neighborhood(_ref2) {
                    ...
                    return (
                        ...
                        Math.exp(
                            -(
                                Math.pow(n.pos[0] - bmu.pos[0], 2) /
                                    2 *
                                    Math.pow(sigmaX, 2) +
                                Math.pow(n.pos[1] - bmu.pos[1], 2) /
                                    2 *
                                    Math.pow(sigmaY, 2)
                            )
                        ) *
